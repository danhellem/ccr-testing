      ...
      <aside className="cart-panel">
        ...
        {items.length === 0 ? (
          <div className="cart-empty">
            <div className="empty-icon"><ShoppingCart size={56} strokeWidth={1.2} /></div>
              ...
              {items.map(item => (
                <div key={item.id} className="cart-item">
                  ...
                  <div className="cart-item-right">
                    ...
                    <button className="remove-btn" onClick={() => onRemove(item.id)} aria-label="Remove item"><Trash2 size={16} /></button>
                  </div>
                </div>
              ))}
            </div>
